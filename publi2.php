...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        $rech1 = $rech1. "<tr>
           <td><b>". htmlspecialchars($row["etablissement"])."</b><br>". htmlspecialchars($row["zip"])." ". htmlspecialchars($row["ville"])."<br></td>
           <td><b>". htmlspecialchars($row["prenom"])."</b><br>". htmlspecialchars($row["telephone"])."<br>". htmlspecialchars($row["email"])."<br></td>
